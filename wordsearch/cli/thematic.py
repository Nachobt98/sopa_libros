...
This module keeps the command-line interface and orchestration currently used by
`main_thematic.py`, while allowing the top-level script to remain a thin wrapper.
"""
